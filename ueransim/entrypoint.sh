...
tshark -i uesimtun0 -w /ueransim/logs/uesimtun0.pcap -f "not (arp or tcp or udp) or (tcp port 5001)" -s 96 &
tshark -i uesimtun1 -w /ueransim/logs/uesimtun1.pcap -f "not (arp or tcp or udp) or (tcp port 5001)" -s 96
